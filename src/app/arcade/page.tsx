      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-5 py-12">
        ...
        <div className="text-center mb-16">
          <motion.div
            ...
            className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#e62e2d]/20 border border-[#e62e2d]/50 mb-6"
          >
            <Gamepad2 className="text-[#e62e2d]" size={32} />
          </motion.div>
          <div className="inline-flex items-center gap-2 text-[10px] sm:text-xs tracking-[0.4em] uppercase font-bold text-white/50 mb-4 justify-center">
            Mecharush '26
