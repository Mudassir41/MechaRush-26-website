...
const CONTACTS = [
  { name: "Sathick. A.S", role: "Tech Coordinator", value: "+91 6381032845", type: "tel" },
  { name: "Susikaran V S", role: "Non-Tech Coord", value: "+91 7305432674", type: "tel" },
  { name: "Support Email", role: "General Inquiry", value: "contact@mecharush.in", type: "email" },
];
      ...
      >
        <div className="w-full px-6 lg:px-12 h-20 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 flex-shrink-0">
            ...
            >
              <img src="/assets/crescent-logo-white.png" alt="Crescent Logo" className="h-10 w-32 object-contain hidden md:block" />
              <img src="/assets/crescent-logo-mobile.png" alt="Crescent Logo" className="h-10 w-10 object-contain block md:hidden" />
            </a>
          </div>
            ...
            >
              ...
              <nav className="flex-1 overflow-y-auto p-6 space-y-2">
                ...
                <div className="pt-6 mt-8 border-t border-white/[0.05]">
                  ...
                  {CONTACTS.map(({ name, role, value, type }) => (
                    <a key={name} href={type === "email" ? `mailto:${value}` : `tel:${value}`}
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-[11px] font-mono text-white/30 truncate max-w-[120px]">{value}</span>
                        <div className="w-8 h-8 rounded-full bg-[#e62e2d]/10 flex items-center justify-center group-hover:bg-[#e62e2d] transition-colors">
                          {type === "email" ? (
                            <Mail size={13} className="text-[#e62e2d] group-hover:text-white" />
                          ) : (
